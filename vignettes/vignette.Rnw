...
\title{An R package for the inference of statistically significant temporal patterns involving alternations in driver genes from cancer genomics data}
...
\section{Using the ASCETIC R package}

ASCETIC is an R package for the inference of statistically significant temporal patterns involving alternations in driver genes. The framework can be applied to data at different resolutions, from classical NGS genomics data of cancer samples, to single-cell data.
